...
class L10nCUSaclapImportWizard(models.TransientModel):
    _name = "l10n.cu.saclap.import"
    _inherit = "res.config.installer"
    _description = "SACLAP HS Code Import for Cuba"
    ...
    def _import_hs_codes(self):
        ...
        path = os.path.join(
            get_resource_path("l10n_cu_saclap"), "data", "NC_21.xls"
        )
